...
export const recentPost: Post[] = [
  ...
  },
  {
    ...
    subTitle: '"Conflictos y más Conflictos"',
    image: '../../assets/recent-post/politica.jpg',
    content:
      'La política internacional se encuentra en constante evolución, y hoy más que nunca, enfrenta desafíos complejos que afectan a nivel global. Desde conflictos regionales hasta cuestiones medioambientales, pasando por la lucha contra el terrorismo y la gestión de la economía mundial, la política internacional se presenta como un campo donde las naciones deben cooperar y resolver sus diferencias. \n\nUno de los desafíos más apremiantes es el cambio climático. El calentamiento global, provocado en gran medida por las emisiones de gases de efecto invernadero, amenaza la estabilidad del planeta y exige una acción coordinada a nivel internacional. Acuerdos como el Acuerdo de París buscan abordar este problema, pero la implementación efectiva sigue siendo un reto. Los conflictos armados y las tensiones geopolíticas también están en el centro de la política internacional. Las crisis en Ucrania, Siria y otros lugares continúan generando preocupación, y la diplomacia internacional busca soluciones pacíficas para estos conflictos.\n\nAdemás, la rivalidad entre superpotencias como Estados Unidos, China y Rusia crea un escenario complicado que requiere una diplomacia hábil. La ciberseguridad es otra preocupación importante en la política internacional. Los ataques cibernéticos, ya sean perpetrados por Estados, grupos terroristas o delincuentes cibernéticos, pueden tener un impacto devastador en la infraestructura crítica y la privacidad de las personas. La cooperación internacional en materia de ciberseguridad es esencial. La economía global presenta su propio conjunto de desafíos. La lucha contra la desigualdad económica, el comercio internacional y la regulación financiera son temas en constante debate. Además, la pandemia de COVID-19 ha tenido un impacto significativo en la economía mundial, lo que requiere una respuesta coordinada a nivel internacional. \n\nEn resumen, la política internacional afronta desafíos múltiples y complejos en la actualidad. La cooperación y la diplomacia son fundamentales para abordar estas cuestiones y encontrar soluciones efectivas. A medida que el mundo se vuelve cada vez más interconectado, la política internacional desempeña un papel crucial en la promoción de la paz, la estabilidad y el bienestar global.',
    resume:
